...
contract checkdata {
    ...
    function setData(address _account, uint256 _carbo, uint256 _protein, uint256 _fat) external {
       Datas.push(Data(_account, _carbo, _protein, _fat));
       require(Datas.push(Data(_account, _carbo, _protein, _fat)) != 0);
    } 
    
    function getData(uint _datas) public view returns(address getaccount, uint256 getcarbo, uint256 getprotein, uint256 getfat){
        getaccount = Datas[_datas].account;
        getcarbo = Datas[_datas].carbo;
        getprotein = Datas[_datas].protein;
        getfat = Datas[_datas].fat;
    }
